<section class="website-section website-section--gallery" data-reveal>
    <div class="website-container">
        ...
        @endif
        @foreach(\Modules\Website\Models\GalleryAlbum::query()->where('is_published', true)->orderBy('sort_order')->with('items')->get() as $album)
            <div class="website-card"><h3>{{ $album->title }}</h3><p>{{ $album->items->count() }} photos</p></div>
        @endforeach
    </div>
</section>
